...
const searchScopeMetadataMap = {
  lecture: {
    browseDescription:
      '강의 영역의 제목, 소개 문구, 카테고리, 태그를 기준으로 원하는 프로그램을 찾아보실 수 있습니다.',
  ...
  notice: {
    browseDescription:
      '공지사항 영역의 제목, 안내 문구, 카테고리, 태그를 기준으로 필요한 소식을 찾아보실 수 있습니다.',
    inputLabel: '공지사항 검색',
    label: '공지사항',
  ...
  qna: {
    browseDescription:
      'Q&A 영역의 제목, 질문 설명, 카테고리, 태그를 기준으로 비슷한 질문과 답변을 찾아보실 수 있습니다.',
    inputLabel: 'Q&A 검색',
    label: 'Q&A',
  ...
  resource: {
    browseDescription:
      '자료실 영역의 제목, 자료 설명, 카테고리, 태그를 기준으로 필요한 다운로드 자료를 찾아보실 수 있습니다.',
    inputLabel: '자료실 검색',
    label: '자료실',
  ...
  review: {
    browseDescription:
      '교육후기 영역의 제목, 후기 설명, 카테고리, 태그를 기준으로 실제 수강 경험을 찾아보실 수 있습니다.',
    inputLabel: '교육후기 검색',
    label: '교육후기',
