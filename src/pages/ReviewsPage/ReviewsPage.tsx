...
const ReviewsPage = () => {
  ...
  const heroAside = (
    <>
      ...
      <article className={shared['metricCard']}>
        <p className={shared['metricValue']}>{String(reviewBoardQuery.data.reviewedProgramCount)}개</p>
        <p className={shared['metricLabel']}>후기가 확인된 과정 수</p>
      </article>
      <article className={shared['metricCard']}>
        <p className={shared['metricValue']}>{String(reviewBoardQuery.data.sourceProgramCount)}개</p>
  ...
  let content = (
    <section className={shared['stateSection']}>
      <div className={shared['stateContent']}>
        ...
        <p className={shared['stateDescription']}>새로운 수강 후기가 등록되면 과정별로 이 페이지에 모아 보여 드립니다.</p>
      </div>
    </section>
  );
    ...
    content = (
      <section aria-busy='true' className={shared['stateSection']}>
        <div className={shared['stateContent']}>
          ...
          <p className={shared['stateDescription']}>각 과정 상세 페이지의 수강 후기를 순서대로 집계하고 있습니다.</p>
        </div>
      </section>
    );
      ...
      <div className={shared['splitLayout']}>
        <section className={shared['sectionCard']}>
          <div className={shared['panelHeader']}>
            ...
            <p className={shared['helperText']}>홈 대표 후기 섹션의 톤을 유지하면서 과정별 후기를 한곳에 모았습니다.</p>
          </div>
          ...
          <section className={shared['sectionCard']}>
            ...
            <ul className={shared['metaList']}>
              <li>
                ...
                <p className={shared['metaText']}>과정 상세 페이지에 공개된 실제 수강 후기를 모아 보여 줍니다.</p>
              </li>
              <li>
                <p className={shared['metaLabel']}>정렬 기준</p>
                <p className={shared['metaText']}>최신 등록일 우선, 같은 날짜면 평점이 높은 후기를 먼저 노출합니다.</p>
              </li>
              <li>
                <p className={shared['metaLabel']}>상세 이동</p>
                <p className={shared['metaText']}>모든 카드에서 해당 과정 상세 페이지로 바로 이동할 수 있습니다.</p>
              </li>
            </ul>
          </section>
        </aside>
  ...
  return (
    <PublicBoardLayout
      ...
      description={
        <p>과정별 리뷰를 한 페이지에서 먼저 훑어보고, 필요하면 각 과정 상세로 바로 이동할 수 있게 구성했습니다.</p>
      }
