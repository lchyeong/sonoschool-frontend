...
const createWrapper = () => {
  ...
  const PaymentResultQueryWrapper = ({ children }: { children: ReactNode }) => {
    return <QueryClientProvider client={queryClient}>{children}</QueryClientProvider>;
  };
  PaymentResultQueryWrapper.displayName = 'PaymentResultQueryWrapper';

  return PaymentResultQueryWrapper;
};
