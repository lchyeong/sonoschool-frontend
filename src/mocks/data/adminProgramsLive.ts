...
const INITIAL_PROGRAMS: AdminProgramStateItem[] = [
  ...
  },
  {
    ...
    level: 'INTERMEDIATE',
    instructorName: '박선영',
    instructorBio: '실습 운영과 임상 적용 교육을 함께 담당하는 강사입니다.',
    price: 480000,
    salePrice: 420000,
    maxStudents: null,
    currentStudents: 9,
    ...
    faqs: [{ question: '실습 예약은 별도인가요?', answer: '수강 후 실습 가능 슬롯을 예약할 수 있습니다.' }],
    tags: [],
    documents: [],
    deletable: true,
    deleteBlockedReason: null,
  },
  {
    ...
    level: 'INTERMEDIATE',
    instructorName: '김도윤',
    instructorBio: '시험 대비 문제풀이 설계를 담당하는 강사입니다.',
    price: 160000,
    salePrice: 120000,
    maxStudents: null,
    currentStudents: 4,
    ...
    summaryItems: [
      { label: '문제풀이 전용', value: '문제강의와 첨부자료만으로 구성합니다.' },
    ],
    faqs: [{ question: '영상강의가 포함되나요?', answer: '이 과정은 문제강의와 첨부자료만 제공합니다.' }],
    tags: [],
    documents: [],
    deletable: true,
    deleteBlockedReason: null,
